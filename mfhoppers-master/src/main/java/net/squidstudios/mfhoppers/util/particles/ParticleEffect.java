package net.squidstudios.mfhoppers.util.particles;
...
public enum ParticleEffect {
     ...
     * <ul>
     * <li>It looks like a tiny particles of the slimeball icon
     * <li>The speed value has no influence on this particle effect
     * </ul>
     */
    SLIME("slime", 33, - 1),
    ...
    private static boolean isWater(Location location) {
        ...
        return material == Material.WATER || material == MMaterial.matchMaterial("STATIONARY_WATER");
    }
     ...
     * This class is particles of the <b>ParticleEffect Library</b> and follows the same usage conditions
     *
     * @author DarkBlade12
     * @since 1.7
     */
    ...
    public static final class ParticlePacket {
        ...
        public static void initialize() throws VersionIncompatibleException {
            ...
            try {
                ...
                throw new VersionIncompatibleException("MFHoppers currently doesn't support particles for your server version", exception);
            }
            initialized = true;
        }
